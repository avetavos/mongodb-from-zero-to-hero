...
<Mermaid code={txnFlow} title="transaction เริ่มใน session รัน operation ทั้งชุด แล้ว commit การเปลี่ยนแปลงพร้อมกัน หรือไม่ก็ abort แล้ว roll back กลับทั้งหมด" />
...
>
> **แพลตฟอร์มแลกเปลี่ยนสินทรัพย์ดิจิทัลทั่วไป** — ใช้ transaction ที่ผูกกับ session เพื่อรักษาความถูกต้องของยอดเงินดิจิทัลข้าม ledger document หลายฉบับ เพราะข้อผิดพลาดด้าน consistency ในระบบการเงินมีต้นทุนสูงกว่าการแลก latency ที่เพิ่มขึ้นจาก transaction มาก
...
export const quizMulti = [
  ...
  },
  {
    ...
    options: [
      'ยัดงานให้มากที่สุดเท่าที่ทำได้ไว้ข้างใน',
      'ทำให้สั้นที่สุด แล้วย้ายงานช้าออกไปข้างนอก',
      'ใส่การเรียกผ่านเครือข่ายไว้ข้างในเสมอ',
