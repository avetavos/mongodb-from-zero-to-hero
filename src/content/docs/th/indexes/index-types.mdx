...
| unique index | รับประกันความไม่ซ้ำของข้อมูลในระดับ database | insert หรือ update ที่ทำให้ค่าซ้ำจะโดน reject ทันที ต้องเขียน error path รองรับเพิ่ม |
...
export const quizTypes = [
  ...
  },
  {
    ...
    options: [
      ...
      'เพื่อให้ document จำนวนมากไม่มีฟิลด์นั้นได้ แต่ยังห้ามค่าซ้ำในกลุ่มที่มีค่า',
