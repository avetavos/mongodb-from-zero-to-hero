...
>
> **รายงานราคาอสังหาริมทรัพย์ทั่วไป** — ระบบที่ต้องแบ่งกลุ่มบ้านเป็นช่วงราคา (budget/mid-range/luxury) มักใช้ `$bucket` กับขอบเขตที่ทีมธุรกิจกำหนดไว้ตายตัว ส่วนการสำรวจตลาดใหม่ที่ยังไม่รู้การกระจายราคาใช้ `$bucketAuto` เพื่อให้ระบบแบ่งกลุ่มให้อัตโนมัติ — Keller Williams ใช้แนวทาง aggregation pipeline แบบเดียวกันนี้ในการสรุปข้อมูล listing กว่า 70 ล้านระเบียนบน MongoDB Atlas ([mongodb.com/customers/keller-williams](https://www.mongodb.com/customers/keller-williams))
