...
>
> **รายงานอสังหาริมทรัพย์ทั่วไป** — filter บน field อย่าง region และ status ด้วย `$match` ก่อนเสมอ เพื่อให้ index ตัด document ส่วนใหญ่ทิ้งได้ทันที แล้วค่อย `$project` ให้เหลือเฉพาะ field ที่ทีมขายต้องเห็นในรายงาน — Keller Williams ใช้ MongoDB aggregation pipeline ในลักษณะนี้กับข้อมูล listing บน Atlas ([mongodb.com/customers/keller-williams](https://www.mongodb.com/customers/keller-williams))
