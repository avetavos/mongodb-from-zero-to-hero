...
> 💡 ตัวอย่างจากของจริง
>
> **Forbes** — ย้าย CMS จาก schema แบบ relational เดิมมาเป็น MongoDB Atlas เพราะ schema ที่ยืดหยุ่นของ document model ช่วยให้ทีมพัฒนาฟีเจอร์ได้เร็วขึ้น ([mongodb.com/customers/forbes](https://www.mongodb.com/customers/forbes), 2019)
>
> **ทีมที่รวมข้อมูลลูกค้าจากหลายระบบเดิม** — สร้างระบบ "single customer view" ด้วย MongoDB โดยรวมข้อมูลลูกค้าจากระบบ relational เดิมหลายสิบระบบให้เป็น document เดียวต่อลูกค้าหนึ่งคน แทนที่จะพยายาม join ข้ามระบบเดิมที่แยกกันอยู่
