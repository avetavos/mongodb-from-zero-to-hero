...
> 💡 ตัวอย่างจากของจริง
>
> **ระบบ ride-hailing/booking ทั่วไป** — พึ่ง replica set กับ automatic failover เพื่อให้ trip data ยังเขียนต่อได้แม้ node ใดตัวหนึ่งล้มเหลวกลางดึกโดยไม่ต้องปลุกใครมาแก้
>
