...
server ใช้การอ่านในลำดับเดิมเสมอ: เลือกสิ่งที่ตรง จัดลำดับ ทิ้งส่วนหน้าที่ถูก skip แล้วจำกัดจำนวน การซึมซับลำดับนั้นบอกคุณว่าทำไมหน้าจึงต้องมี sort และทำไม skip ที่ลึกจึงต้องจ่ายค่าทุก document ที่เดินผ่าน — นั่นคือเมล็ดพันธุ์ของ range-based pagination
</Callout>
...
export const quizPagination = [
  ...
  },
  {
    ...
    options: [
      ...
      'ทำให้ skip ไม่มีต้นทุน',
      'เปลี่ยนว่าจะส่ง field ไหนกลับมา',
    ],
    answer: 1,
  },
  {
    ...
    options: [
      'โหลด collection ทั้งก้อนเข้า memory',
      ' server ต้องเดินผ่าน n ตัวแรกที่ตรงก่อนจึงจะส่งอะไรกลับได้',
      'skip ปิดการ sort',
      'สแกนทุก collection ในฐานข้อมูลเสมอ',
    ],
    answer: 1,
  },
]
